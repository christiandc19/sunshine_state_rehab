...
<section className="contact-container container">
          ...
          <div class="get_form_inner">
            ...
            <form ref={form} onSubmit={sendEmail}>
              ...
              <textarea name="message2" cols="30" rows="3" required>Message Sent to Sunshine State Rehab!</textarea>
              </div>
...
<div className="contact-cards">
    ...
    <div className="contact-card">
        <div className="contact-card-icon">
          ...
          <p>CALL US</p>
          <a href="tel:3234035422">  (123) 456-789</a>
        </div>
    </div>
    ...
    <div className="contact-card">
        <div className="contact-card-icon">
          ...
          <p>EMAIL</p>
          <h5>info@sunshinestaterehab.com</h5>
        </div>
    </div>
